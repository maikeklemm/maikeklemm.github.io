...
function generateZiehstapel() {
    let Ziehstapelneu = document.createElement("img");
...
function KarteZiehen() {
    if (ziehstapelArray.length > 0) {
        player1Array.push(ziehstapelArray[0]); //wenn der spieler nicht kann muss er ziehen, wobei er eine karte aus dem stapel bekommt
        ziehstapelArray.splice(0, 1);
        showKarten();
