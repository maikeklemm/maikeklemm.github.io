...
var playerXP = 0; ///Fehrler behoben                   // Stellt die gesammelte Erfahrung des Spielers dar.
...
var prefix = ["Wald-", "Seuchen-", "Uralte(s) ", "Gift-", "Brennende(s) ", "Kniescheibenzertrümmernde(s) ", "Gemeine(s)", "Öko", "Vegane(s)", "Fluss-", "Haus-"]; // length = 6, da 6 Einträge. Von 0-5.
var monsterName = ["Ratte", "Nagetier", "Ungeziefer", "Monster", "Ding", "Bestie", "Vieh", "Ungeheuer"]; // length = 3, da 3 Einträge. Von 0-2.
var suffix = [" des Verderbens", " aus der Hölle", " der Lethalität", " mit Rheuma", " der Redundanz", " der Zerberstung", " der Highlands", " des indischen Ozeans", " von Neben an", " mit Hunger", " mit Aggressionsproblem"]; // length = 6, da hier 6 Einträge sind. Von 0-5.
...
var monstersnack = ["Butter Toast", "Toast Hawaii", "French Toast", "Schinken Käse Toast"];
// -- Initialisierung für viele/variable Anzahl an Monster --
var monsterArray = []; // Das Haupt-Array wurde erstellt und initialisiert!
console.log(monsterArray); // Gebe das Monster-Array einmal zu beginn aus. Es sollte leer sein.
var Monsterbilder = ["monster1.jpg", "monster2.jpg", "monster3.jpg"];
// ----------- Funktionen ----------- //
...
function generateMonster() {
    ...
    var newMonstersnack = generatemonstersnack();
    var newMonster = {
...
function monsterGenerateHTML() {
    ...
    var monstersnack = document.createElement("p"); // Generiere einen <p>
    monsterMod.innerHTML = monsterArray[monsterArray.length - 1].monsterModifier[0] + ", " + monsterArray[monsterArray.length - 1].monsterModifier[1]; // Inhalt des <p>: Monster-Modifizierer null und eins
